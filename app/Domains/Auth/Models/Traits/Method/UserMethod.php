...
trait UserMethod
{
    ...
    {
        return   $this->attributes['avatar'] ? $this->attributes['avatar']:'https://gravatar.com/avatar/'.md5(strtolower(trim($this->email))).'?s='.config('boilerplate.avatar.size', $size).'&d=mp';
    }
}
