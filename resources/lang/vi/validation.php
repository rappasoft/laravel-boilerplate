    ...
    */
    ...
    'attributes' => [
        ...
        'backend' => [
            'access' => [
                'permissions' => [
                    'associated_roles' => 'Quyền thành viên',
                    'dependencies'     => 'Thuộc',
                    'display_name'     => 'Tên hiện thị',
                    'group'            => 'Nhóm quyền',
                    'group_sort'       => 'Thứ tự nhóm',
                ...
                'roles' => [
                    'associated_permissions' => 'Quyền thành viên',
                    'name'                   => 'Tên hiện thị',
                    'sort'                   => 'Sắp xếp',
                ],
                ...
                'users' => [
                    ...
                    'last_name'               => 'Tên đệm',
                    'first_name'              => 'Tên gọi',
                    'other_permissions'       => 'Quyền chi tiết',
                    'password'                => 'Mật khẩu',
                    'password_confirmation'   => 'Xác thực mật khẩu',
                    'send_confirmation_email' => 'Gửi e-mail kích hoạt',
                ],
            ],
        ],
        ...
        'frontend' => [
            ...
            'new_password_confirmation' => 'Xác thực mật khẩu mới',
