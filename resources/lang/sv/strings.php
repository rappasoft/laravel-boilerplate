...
return [
    ...
    */
    ...
    'backend' => [
        'WELCOME' => 'VÄLKOMMEN',
        'dashboard_title' => 'Huvudpanel för admins',
    ],
    'based_on' => [
        'permission' => 'Rättigheter baserade - ',
        'role' => 'Rollbaserade - ',
    ],
    'be_right_back' => 'Strax tillbaka.',
    'cancel_button' => 'Avbryt',
    'click_here_to_confirm_account' => 'Klicka här för att bekräfta kontot:',
    'click_here_to_reset' => 'Klicka här för att återställa lösenordet:',
    'edit' => 'Redigera',
    'full_name' => 'Namn',
    'if_confirmed_is_off' => '(Om e-postbekräftelse är avstängt)',
    'js_injected_from_controller' => 'Javascript som fått sin data direkt från en controller',
    'member_since' => 'Registrerad sedan',
    'page_not_found' => 'Den sida du försöker nå går inte att hitta',
    'password_successfully_changed' => 'Lösenordet har nu ändrats',
    'profile_successfully_updated' => 'Profilen är nu uppdaterad.',
    'save_button' => 'Spara',
    'search_placeholder' => 'Sök...',
    'see_all' => [
        'messages' => 'Se alla meddelanden',
        'notifications' => 'Se alla',
        'tasks' => 'Se alla uppgifter',
    ],
    'sorry_page_you_were_trying' => 'Ledsen men den sida du försökte nå finns inte.',
    'test' => 'Test',
    'using_access_helper' => [
    ...
    'using_blade_extensions' => 'Använder Blade-Extensions',
    'view_console_it_works' => 'Kolla consollen, du borde se \'it works!\' som skickas direkt från FrontendController@index',
    ...
    'you_have' => [
        ...
        'tasks' => '{0} Du har inga uppgifter|{1} Du har 1 uppgift|[2,Inf] Du har :number uppgifter',
    ],
    'create' => 'Skapa',
    'delete' => 'Radera',
    'permission' => '[0,1]Rättighet|[2,Inf]Rättigheter',
    'role' => '[0,1]Roll|[2,Inf]Roller',
    'user' => '[0,1]Användare|[2,Inf]Användare',
