...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'new_password_confirmation' => 'Bekräfta det nya lösenordet',
        'created_at' => 'Skapad den',
        'last_updated' => 'Uppdaterade senast',
        'actions' => 'Handlingar',
        'active' => 'Aktiv',
        'confirmed' => 'Bekräftad',
        'send_confirmation_email' => 'Skicka bekräftelse-mail',
        'associated_roles' => 'Associerade roller',
        'other_permissions' => 'Andra rättigheter',
        'role_name' => 'Rollens namn',
        'associated_permissions' => 'Associerade rättigheter',
