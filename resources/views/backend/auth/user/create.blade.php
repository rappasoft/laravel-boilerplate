            ...
            <x-slot name="body">
                <div x-data="{userType : '{{ $model::TYPE_USER }}'}">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select name="type" class="form-select mb-3" required x-on:change="userType = $event.target.value">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="name" class="form-control mb-3" placeholder="{{ __('Name') }}" value="{{ old('name') }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="email" name="email" class="form-control mb-3" placeholder="{{ __('E-mail Address') }}" value="{{ old('email') }}" maxlength="255" required />
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="form-check">
                                <input name="active" id="active" class="form-check-input mb-3" type="checkbox" value="1" {{ old('active', true) ? 'checked' : '' }} />
                            </div><!--form-check-->
                        </div>
                    </div><!--form-group-->
