...
@section ('title', trans('labels.backend.content.article.management') . ' | ' . trans('labels.backend.content.article.edit'))
...
@section('content')
    {!! Form::model($model, ['route' => ['admin.content.article.update', $model->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) !!}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.content.article.edit') }}</h3>
