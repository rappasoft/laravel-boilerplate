                    ...
                    <x-slot name="body">
                        <x-forms.patch :action="route('frontend.auth.password.expired.update')">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="password" name="current_password" class="form-control mb-3" placeholder="{{ __('Current Password') }}" maxlength="100" required autofocus />
                                </div>
                            </div><!--form-group-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="password" id="password" name="password" class="form-control mb-3" placeholder="{{ __('New Password') }}" maxlength="100" required autocomplete="password" />
                                </div>
                            </div><!--form-group-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-control mb-3" maxlength="100" placeholder="{{ __('Password Confirmation') }}" required autocomplete="new-password" />
                                </div>
                            </div><!--form-group-->
