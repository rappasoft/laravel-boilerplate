                ...
                <x-frontend.card>
                    ...
                    <x-slot name="body">
                        <x-forms.post :action="route('frontend.auth.register')" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">@lang('Profile Image')</label>

                                <div class="col-md-6">
                                    <input type="file" name="profile_image" id="profile_image" class="form-control" style="padding: 2px" accept="image/*"/>
                                </div>
                            </div>
