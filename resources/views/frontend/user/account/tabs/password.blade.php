<x-forms.patch :action="route('frontend.auth.password.change')">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input type="password" name="password" class="form-control mb-3" placeholder="{{ __('New Password') }}" maxlength="100" required />
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input type="password" name="password_confirmation" class="form-control mb-3" placeholder="{{ __('New Password Confirmation') }}" maxlength="100" required />
        </div>
    </div><!--form-group-->
